    ...
    <section className={styles["about"]}>
      ...
      <div className={styles["about-video"]}>
        <div>
          ...
          >
            <p className="font-regular text-2xl mb-6">¿Qué es MEPC?</p>
            <p>
              Somos un grupo de estudiantes y graduades autoconvocades,
              provenientes de diferentes puntos del país, que compartimos un
              mismo ideal: el desarrollo de una formación y una práctica
              profesional basadas en fundamentos científicos. Nacimos en la
              Facultad de Psicología de la Universidad de Buenos Aires (UBA), y
              ya sumamos alrededor de 3000 personas que creemos que la ciencia
